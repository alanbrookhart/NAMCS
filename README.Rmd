...
* cam = indicator of whether the physician practices alternative medicine
...
* cox2_initiation = new user of COX-2 selective inhibitors versus non-selective NSAIDs
...
* incident_pud = incident peptic ulcer disease during follow-up (simulated)
